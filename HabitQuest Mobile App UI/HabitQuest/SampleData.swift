...
enum SampleData {
    static let habits: [Habit] = [
        Habit(
            ...
            completed: true,
            xp: 50,
            createdAt: Date(timeIntervalSinceNow: -12 * 86_400.0),
            isPaused: false,
            pausedAt: nil,
        ...
        Habit(
            ...
            completed: false,
            xp: 40,
            createdAt: Date(timeIntervalSinceNow: -10 * 86_400.0),
            isPaused: false,
            pausedAt: nil,
        ...
        Habit(
            ...
            completed: true,
            xp: 30,
            createdAt: Date(timeIntervalSinceNow: -9 * 86_400.0),
            isPaused: false,
            pausedAt: nil,
        ...
        Habit(
            ...
            completed: false,
            xp: 60,
            createdAt: Date(timeIntervalSinceNow: -8 * 86_400.0),
            isPaused: false,
            pausedAt: nil,
        ...
        Habit(
            ...
            completed: true,
            xp: 70,
            createdAt: Date(timeIntervalSinceNow: -7 * 86_400.0),
            isPaused: false,
            pausedAt: nil,
            completionHistory: ["2026-03-11", "2026-03-10", "2026-03-09"],
            missedHistory: [],
    ...
    static let achievements: [Achievement] = [
        Achievement(id: "1", title: "First Step", description: "Complete your first habit", icon: "\u{1F3AF}", unlocked: true, claimed: true, unlockedAt: Date(timeIntervalSinceNow: -4 * 86_400.0), progress: nil, total: nil, xpReward: 100),
        Achievement(id: "2", title: "Week Warrior", description: "Maintain a 7-day streak", icon: "\u{26A1}", unlocked: true, claimed: true, unlockedAt: Date(timeIntervalSinceNow: -2 * 86_400.0), progress: nil, total: nil, xpReward: 250),
        Achievement(id: "3", title: "Consistency King", description: "Maintain a 30-day streak", icon: "\u{1F451}", unlocked: false, claimed: false, unlockedAt: nil, progress: 15, total: 30, xpReward: 500),
        Achievement(id: "4", title: "Habit Master", description: "Complete 100 habits total", icon: "\u{1F3C6}", unlocked: false, claimed: false, unlockedAt: nil, progress: 45, total: 100, xpReward: 1000),
        Achievement(id: "5", title: "Early Bird", description: "Complete a habit before 8 AM for 7 days", icon: "\u{1F305}", unlocked: true, claimed: false, unlockedAt: Date(timeIntervalSinceNow: -1 * 86_400.0), progress: nil, total: nil, xpReward: 300),
        Achievement(id: "6", title: "Multi-tasker", description: "Complete 5 habits in a single day", icon: "\u{1F3AA}", unlocked: false, claimed: false, unlockedAt: nil, progress: 3, total: 5, xpReward: 400)
    ]
